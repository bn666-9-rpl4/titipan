 ...
 <div class="navbar-fixed">
  <nav>
    <div class="nav-wrapper light-blue">
      <ul>
         <li><a href="../login.php" class="btn tooltipped" data-position="bottom" data-delay="50" data-tooltip="Untuk Penyewa"><i class="material-icons white-text left"></i>LOGOUT</a></li>
      </ul>
