...
<body>
  ...
  <nav>
    <div class="nav-wrapper light-blue">
      <ul>
      	<li><a href="../login.php" class="btn tooltipped" data-position="bottom" data-delay="50" data-tooltip="Khusus ADMIN"><i class="material-icons white-text left">account_circle</i>LOGIN</a></li>
      </ul>
